...
This function normalizes a list of distance matrices by their top
singular value so that after normalization, each distance matrix has a
top singular value of 1. This ensures that the distance matrices are on
similar scales, making the CoMDS optimization problem more stable and
easier to optimize.
