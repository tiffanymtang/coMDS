...
reproducible R environment. To install the necessary dependencies and
...
4.  Download the datasets used in the manuscript from
    [Zenodo](https://zenodo.org/records/17956327) and place them in the
    `coMDS-manuscript/data/` directory.
5.  Run the analysis and figure-generation scripts as needed (The main
    scripts are in the [scripts/](scripts/) directory and driver scripts
    are in the [job_scripts/](job_scripts/) directory).
